...
public class NetworkManager extends CordovaPlugin {
    ...
    public void onStart() {
        super.onStart();
        KLog.d("onStart");
        if (sockMan != null && NetworkManager.this.webView != null) {
            updateConnectionInfo(sockMan.getActiveNetworkInfo());
        }
    }
    ...
    private JSONObject getConnectionInfo(NetworkInfo info) {
        ...
        KLog.d("Connection Type: " + type);
        KLog.d("Connection Extra Info: " + extraInfo);
    ...
    private void sendUpdate(String type) {
        ...
        KLog.i("手机网络连接类型：" + type);
//        KLog.file("NetworkManager", FuFuApplication.getmInstance().getExternalCacheDir(), "fufu_" + DateUtil.getCurrentDate() + ".txt", type);
    ...
    private String getType(NetworkInfo info) {
        if (info != null) {
            ...
            KLog.d("Net Type : " + type.toLowerCase());
            if (type.equals(WIFI)) {
                return TYPE_WIFI;
